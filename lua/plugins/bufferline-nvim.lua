    ...
    opts = function()
        ...
        opts.options = {
            ...
            sort_by = function(buffer_a, buffer_b)
                ...
                if winpos_a[2] < winpos_b[2] then return true end
                -- then sort vertical windows
                if winpos_a[2] == winpos_b[2] and winpos_a[1] < winpos_b[1] then return true end
            ...
            custom_filter = function(cur_buf_num, _)
                ...
                for _, buf_num in pairs(win_buf_ls) do
                    if cur_buf_num == buf_num then return true end
                end
                return false
            end,
            -- diagnostics infos
        ...
        if os.getenv('TERMUX_VERSION') then opts.options.separator_style = 'thin' end
