...
map({ 'n', 'v' }, 'C', '"_C')
-- cut
map({ 'n', 'v' }, ';d', '"+d', { desc = 'delete text, copy to clipboard' })
map({ 'n', 'v' }, ';D', '"+D', { desc = 'delete text, copy to clipboard' })
map({ 'n', 'v' }, ';c', '"+c', { desc = 'change text, copy to clipboard' })
map({ 'n', 'v' }, ';C', '"+C', { desc = 'change text, copy to clipboard' })
...
map('n', 'gP', 'P')
map('n', 'p', 'p`]')
-- z*a/<space>*a as change all text operation
...
map('n', '<space>va', 'ggVG', { desc = 'select all text' })
map('n', '<space>ya', 'ggVGy', { desc = 'copy all text' })
map('n', '<space>da', 'ggVG"_d', { desc = 'delete all text' })
map('n', '<space>xa', 'ggVGd', { desc = 'cut all text' })
map('n', '<space>ca', 'ggVG"_c', { desc = 'change all text' })
